...
بعد ذلك اختبر في الهاتف جسم رسالة طويلًا يلتف إلى سطرين، ثم افتح شاشة الاتصال قبل ظهور الفقاعة. يجب أن يبقى جسم الرسالة المتعدد الأسطر هو العنصر الوحيد الذي تتحرك أسطره إلى اليمين؛ أما `Calling` واسم المتصل و`PhoneWave` وكل تسمية حالة قصيرة فتظل في إحداثياتها الأصلية. يعتمد الكود الآن على عدد الأسطر المرئية فعليًا، لا على counters التمرير وحدها، لأن بعض استدعاءات الحالة قد تمرر قيمًا تشبه التمرير رغم أنها أحادية السطر. لا توجد كتابة تدريجية خاصة بالهاتف هنا؛ لذلك لا نحتاج إلى عكس opacity كما في الحوار.

اختبر كذلك مرحلة ظهور فقاعة المكالمة. يجب أن تبقى الفقاعة وهندستها في المسار الأصلي LTR، كما في الصورة المرجعية: الفقاعة على يسار الهاتف، وطرفها يصل إلى حافة الهاتف، ولا تُطبَّق عليها `rtlPhoneRightX`. إذا ظهرت الفقاعة أو خلفيتها في موضع مختلف، فالمشكلة ليست في محاذاة جسم الهاتف، لأن `drawChatMessageHook` لا يستدعي helper RTL. اختبر أيضًا رسالة قصيرة من سطر واحد؛ بقاءها LTR في الوضع الآمن مقصود، وهو أفضل من إزاحة عنصر واجهة إلى موضع خاطئ. إذا أردت تجربة المحاذاة العامة لكل الاستدعاءات، اضبط `rtlPhoneMultilineOnly: false` مؤقتًا، لكن لا تعتمد ذلك قبل اختبار كل شاشات الهاتف.
