...
// Set by the dialogue wordwrap hook and captured per dialogue page.
LB_GLOBAL bool DIALOGUE_PAGE_HAS_NAME;
...
LB_GLOBAL float ARABIC_HARAKAT_KASRA_Y;
LB_GLOBAL float ARABIC_HARAKAT_SHADDA_X;
LB_GLOBAL float ARABIC_HARAKAT_SHADDA_Y;
LB_GLOBAL float ARABIC_HARAKAT_SHADDA_UPPER_X;
LB_GLOBAL float ARABIC_HARAKAT_SHADDA_UPPER_Y;
LB_GLOBAL float ARABIC_HARAKAT_SHADDA_KASRA_X;
LB_GLOBAL float ARABIC_HARAKAT_SHADDA_KASRA_Y;
